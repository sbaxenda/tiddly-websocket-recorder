/*\
title: $:/plugins/sbaxenda/tiddly-websocket-recorder/action-stopwebsocketserver.js
type: application/javascript
module-type: widget

  Action widget to stop a WebSocket server

  <$action-stopwebsocketserver $server=tiddlerDefiningWebSocketServer/>

  ex.

  <$action-stopwebsocketserver $server="$:/WebSocketServer"/>

  stops the WebSocket server defined in the $server tiddler
...
(function(){
    ...
    var ActionStopWebSocketServer= function(parseTreeNode,options) {
    ...
    */
    ActionStopWebSocketServer.prototype = new Widget();

    /*
      Render this widget into the DOM
    */
    ActionStopWebSocketServer.prototype.render = function(parent,nextSibling) {
    ...
    */
    ActionStopWebSocketServer.prototype.execute = function() {
    ...
    */
    ActionStopWebSocketServer.prototype.refresh = function(changedTiddlers) {
    ...
    */
    ActionStopWebSocketServer.prototype.invokeAction = function(triggeringWidget,event) {
    ...
    exports["action-stopwebsocketserver"] = ActionStopWebSocketServer;
